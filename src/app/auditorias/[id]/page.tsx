...
import { ArrowLeft, Loader2, ExternalLink, AlertTriangle, AlertCircle, CheckCircle2 } from 'lucide-react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: 'var(--bg-base)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px', borderBottom: '1px solid var(--border-subtle)', backgroundColor: 'var(--bg-surface)', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ fontSize: 15, fontWeight: 500, color: 'var(--text-primary)' }}>Auditoria — {auditoria.leadNome}</div>
        </div>
