...
export default function ClientesPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <PageHeader title="Clientes" icon={Briefcase} actions={
      ...
      <div className="flex-1 overflow-auto p-5">
        {clientes.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full gap-3 text-center">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: 'var(--pill-blue-bg)' }}><Briefcase size={20} className="text-accent-blue" /></div>
              ...
              <Link key={c.id} href={`/clientes/${c.id}`}>
                <div className="card p-4 hover:border-border-strong cursor-pointer transition-all">
                  <div className="flex items-start justify-between mb-3">
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center text-[13px] font-semibold text-accent-blue" style={{ backgroundColor: 'var(--pill-blue-bg)' }}>
